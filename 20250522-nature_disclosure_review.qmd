...
1. Ownership Dynamics: The role of institutional and state ownership in shaping ESG outcomes remains inconsistent across studies [@DYCK2019; @RAIMO2020], with concentrated ownership marginalising minority shareholder influence on CSR practices [@SMITH2022].

2. Regulatory Efficacy: Sector-specific analyses of mandatory frameworks (e.g., CSRD, EU Taxonomy) are scarce, particularly their impact on bank risk profiles and governance mechanisms.

3. Systemic Risk Implications: The interplay between ESG disclosures and systemic financial stability, especially during regulatory shocks (e.g., rapid green  and climate transitions), lacks empirical rigor [@ESRB2016].
